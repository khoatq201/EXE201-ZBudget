                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      ...
                      _themeService.getPrimaryColor().withValues(alpha: 0.8),
                    ],
                  ),
                ),
                child: Stack(
            ...
            children: [
              ListTile(
                ...
                leading: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected
                        ? _themeService.getPrimaryColor().withValues(alpha: 0.1)
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: scheme.color.withValues(alpha: 0.3),
                                blurRadius: 8,
                                offset: const Offset(0, 2),
                              ),
                            ],
        ...
        children: [
          ...
          _buildSettingTile(
            ...
            trailing: Switch(
              ...
              activeThumbColor: _themeService.getPrimaryColor(),
              onChanged: (value) {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
                color: _themeService.getPrimaryColor().withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(
                  _themeService.themeSettings.borderRadius,
                ),
                border: Border.all(
                  color: _themeService.getPrimaryColor().withValues(alpha: 0.3),
                ),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
