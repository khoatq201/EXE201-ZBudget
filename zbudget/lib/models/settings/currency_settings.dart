...
enum Currency {
  ...
  static List<Currency> get majorCurrencies => [Currency.usd, Currency.eur];

  /// Get Asian currencies
  static List<Currency> get asianCurrencies => [Currency.vnd];

  /// Get European currencies
  static List<Currency> get europeanCurrencies => [Currency.eur];
